...
require_relative ENV['BASE_DIR'] + '/source/code/plugins/baseline_lib'

class BaselineLibTest < Test::Unit::TestCase
    def setup
        OMS::Baseline.log = OMS::MockLog.new
    end    
    ...
    def test_baseline_with_corect_input
        ...
        baseline_blob, baseline_summary_blob = OMS::Baseline.transform_and_wrap(baseline_results_json, "test_host", "")        
        
        assert_equal(baseline_blob["DataType"], "SECURITY_BASELINE_BLOB", "Incorrect 'DataType' value") 
        assert_equal(baseline_blob["IPName"], "Security", "Incorrect 'IPName' value")
        
        baseline_item_0 = baseline_blob["DataItems"][0]
        ...
        baseline_item_1 = baseline_blob["DataItems"][1]
        ...
        assert_equal(baseline_summary_blob["DataType"], "SECURITY_BASELINE_SUMMARY_BLOB", "Incorrect 'DataType' value") 
        assert_equal(baseline_summary_blob["IPName"], "Security", "Incorrect 'IPName' value")
        
        baseline_summary_item = baseline_summary_blob["DataItems"][0]
    ...
    def test_baseline_with_empty_input
        ...
        assert_equal(baseline_blob, nil, "Incorrect error case support") 
        assert_equal(baseline_summary_blob, nil, "Incorrect error case support") 
    end
